...
void HZZ_plot_analysis_beam_resolution_morecut_3_TeV_eta4(){
  
  //TFile *f0 = TFile::Open("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/h_signal/Events/h_signal_beam_resolution.root");
  TFile *f0 = TFile::Open("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/h_signal/Events/3_TeV/tag_4_delphes_events.root");
  ...
  TFile *f1 = TFile::Open("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/jj_bkg/Events/3_TeV/tag_3_TeV_delphes_events.root");
  ...
  TFile *f2 = TFile::Open("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/ww_bkg/Events/3_TeV/tag_1_delphes_events.root");
  ...
  //TFile *f3 = TFile::Open("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/mumu_bkg/Events/3_TeV/tag_1_delphes_events.root");
  ...
  TFile *f4 = TFile::Open("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/mumua_bkg/Events/3_TeV/tag_1_delphes_events.root");
  ...
  TFile *f5 = TFile::Open("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/vmvm_bkg/Events/3_TeV_2/tag_1_delphes_events.root");
  ...
  TFile *f6 = TFile::Open("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/ee_bkg/Events/3_TeV/tag_1_delphes_events.root");
  ...
  TH1F *ForwardMuon_E_plot_signal = new TH1F("Forwardmuon_E_signal","",25,-10,3000);
  TH1F *ForwardMuon_PT_plot_signal = new TH1F("Forwardmuon_PT_signal","",25,-10,400);
  TH1F *ForwardMuon_sumPT_plot_signal = new TH1F("Forwardmuon_sumPT_signal","",50,-10,250);
  TH1F *ForwardMuon_Emin_plot_signal = new TH1F("Forwardmuon_Emin_signal","",25,-10,2000);
  ...
  TH1F *ForwardMuon_E_plot_ww_bkg = new TH1F("Forwardmuon_E_ww_bkg","",25,-10,3000);
  TH1F *ForwardMuon_PT_plot_ww_bkg = new TH1F("Forwardmuon_PT_ww_bkg","",25,-10,400);
  TH1F *ForwardMuon_sumPT_plot_ww_bkg = new TH1F("Forwardmuon_sumPT_ww_bkg","",50,-10,250);
  TH1F *ForwardMuon_Emin_plot_ww_bkg = new TH1F("Forwardmuon_Emin_ww_bkg","",25,-10,2000);
  
  
  TH1F *ForwardMuon_Eta_plot_mumua_bkg = new TH1F("Forwardmuon_Eta_mumua_bkg","",100,-10,10);
  TH1F *ForwardMuon_E_plot_mumua_bkg = new TH1F("Forwardmuon_E_mumua_bkg","",25,-10,3000);
  TH1F *ForwardMuon_PT_plot_mumua_bkg = new TH1F("Forwardmuon_PT_mumua_bkg","",25,-10,400);
  TH1F *ForwardMuon_sumPT_plot_mumua_bkg = new TH1F("Forwardmuon_sumPT_mumua_bkg","",50,-10,250);
  TH1F *ForwardMuon_Emin_plot_mumua_bkg = new TH1F("Forwardmuon_Emin_mumua_bkg","",25,-10,2000);
  ...
  TH1F *ForwardMuon_E_plot_ff_bkg = new TH1F("Forwardmuon_E_ff_bkg","",25,-10,3000);
  TH1F *ForwardMuon_PT_plot_ff_bkg = new TH1F("Forwardmuon_PT_ff_bkg","",25,-10,400);
  TH1F *ForwardMuon_sumPT_plot_ff_bkg = new TH1F("Forwardmuon_sumPT_ff_bkg","",50,-10,250);
  TH1F *ForwardMuon_Emin_plot_ff_bkg = new TH1F("Forwardmuon_Emin_ff_bkg","",25,-10,2000);
  
  
  
  
  
  TH1F *Higgs_mass_plot_signal = new TH1F("Higgs_mass_signal","",50,-2000,2000);
  //TH1F *Higgs_mass_plot_jj_bkg = new TH1F("Higgs_mass_jj_bkg","Higgs_mass_jj_bkg",50,-5000,5000);
  TH1F *Higgs_mass_plot_ww_bkg = new TH1F("Higgs_mass_ww_bkg","",50,-2000,2000);
  //TH1F *Higgs_mass_plot_mumu_bkg = new TH1F("Higgs_mass_mumu_bkg","Higgs_mass_mumu_bkg",50,-5000,5000);
  TH1F *Higgs_mass_plot_mumua_bkg = new TH1F("Higgs_mass_mumua_bkg","",50,-2000,2000);
  ...
  TH1F *Higgs_mass_plot_ff_bkg = new TH1F("Higgs_mass_ff_bkg","",50,-2000,2000);
  ...
  double Muon_Emin_cut=800.0;
  ////////////////////////10TeV Signal////////////////////////////////////////////////
  double weight_signal=0.05/100000.0;
  for (int i=0; i<entries0; ++i){
    ...
    if(ForwardMuon_size == 2) {
        ...
        if(abs(ForwardMuon_Eta[0])>4 || abs(ForwardMuon_Eta[1])>4){continue;}
        ...
        if((ForwardMuon_Eta[0] > 0 && ForwardMuon_Eta[1]<0)||(ForwardMuon_Eta[1] > 0 && ForwardMuon_Eta[0]<0)){
            ...
            if(ForwardMuon_PT[0]>20 && ForwardMuon_PT[1]>20){
                ...
                if(Twomuon_PT > 50){
                    ...
                    if(Muon_Emin > Muon_Emin_cut){
                        countnumber_signal[5]=countnumber_signal[5]+1;
                        if(Muon1.E() < Muon2.E()){Muon_Emin=Muon1.E();Muon_Ptmin=Muon1.Pt(); ForwardMuon_PT_plot_signal->Fill(Muon1.Pt(),weight_signal);}
            ...
            if(ForwardMuon_PT[0]>20 && ForwardMuon_PT[1]>20){
                ...
                if(Twomuon_PT > 50){
                    ...
                    if(Muon_Emin > Muon_Emin_cut){
                        ...
                        if(Muon1.E() < Muon2.E()){Muon_Emin=Muon1.E();Muon_Ptmin=Muon1.Pt(); ForwardMuon_PT_plot_ff_bkg->Fill(Muon1.Pt(),weight_jj);}
  ...
  //////////////////////////ww_bkg//////////////////////////////////////////////////////////////////////
  double weight_ww=0.3386/100000.0;
    ...
    if(ForwardMuon_size == 2) {
        ...
        if((ForwardMuon_Eta[1] > 0 && ForwardMuon_Eta[0] < 0)||(ForwardMuon_Eta[0] > 0 && ForwardMuon_Eta[1] < 0)){
            ...
            if(ForwardMuon_PT[0]>20 && ForwardMuon_PT[1]>20){
                ...
                //ForwardMuon_sumPT_plot_total_bkg->Fill(Twomuon_PT,weight_ww);
                if(Twomuon_PT > 50){
                    countnumber_ww_bkg[4]=countnumber_ww_bkg[4]+1;
                    ForwardMuon_E_plot_ww_bkg->Fill(Muon1.E(),weight_ww);
                    //ForwardMuon_PT_plot_ww_bkg->Fill(Muon1.Pt(),weight_ww);
                    ...
                    if(Muon_Emin > Muon_Emin_cut){
                        ...
                        if(Muon1.E() < Muon2.E()){Muon_Emin=Muon1.E();Muon_Ptmin=Muon1.Pt(); ForwardMuon_PT_plot_ww_bkg->Fill(Muon1.Pt(),weight_ww);}
  ...
  //////////////////////////mumua_bkg//////////////////////////////////////////////////////////////////////
  double weight_mumua=753.9/100000.0;
        ...
        if((ForwardMuon_Eta[1] > 0 && ForwardMuon_Eta[0] < 0)||(ForwardMuon_Eta[0] > 0 && ForwardMuon_Eta[1] < 0)){
            ...
            if(ForwardMuon_PT[0]>20 && ForwardMuon_PT[1]>20){
                ...
                if(Twomuon_PT > 50){
                    ...
                    ForwardMuon_E_plot_mumua_bkg->Fill(Muon1.E(),weight_mumua);
                    //ForwardMuon_PT_plot_mumua_bkg->Fill(Muon1.Pt(),weight_mumua);
                    ...
                    if(Muon_Emin > Muon_Emin_cut){
                        ...
                        if(Muon1.E() < Muon2.E()){Muon_Emin=Muon1.E();Muon_Ptmin=Muon1.Pt(); ForwardMuon_PT_plot_mumua_bkg->Fill(Muon1.Pt(),weight_mumua);}
  ...
  //////////////////////////vmvm_bkg//////////////////////////////////////////////////////////////////////
  double weight_vmvm=1.04/40000.0;
        ...
        if((ForwardMuon_Eta[1] > 0 && ForwardMuon_Eta[0] < 0)||(ForwardMuon_Eta[0] > 0 && ForwardMuon_Eta[1] < 0)){
            ...
            if(ForwardMuon_PT[0]>20 && ForwardMuon_PT[1]>20){
                ...
                if(Twomuon_PT > 50){
                    ...
                    ForwardMuon_E_plot_ff_bkg->Fill(Muon1.E(),weight_vmvm);
                    //ForwardMuon_PT_plot_ff_bkg->Fill(Muon1.Pt(),weight_vmvm);
                    ...
                    if(Muon_Emin > Muon_Emin_cut){
                        ...
                        if(Muon1.E() < Muon2.E()){Muon_Emin=Muon1.E();Muon_Ptmin=Muon1.Pt(); ForwardMuon_PT_plot_ff_bkg->Fill(Muon1.Pt(),weight_vmvm);}
        ...
        if((ForwardMuon_Eta[1] > 0 && ForwardMuon_Eta[0] < 0)||(ForwardMuon_Eta[0] > 0 && ForwardMuon_Eta[1] < 0)){
            ...
            if(ForwardMuon_PT[0]>20 && ForwardMuon_PT[1]>20){
                ...
                if(Twomuon_PT > 50){
                    ...
                    ForwardMuon_E_plot_ff_bkg->Fill(Muon1.E(),weight_ee);
                    //ForwardMuon_PT_plot_ff_bkg->Fill(Muon1.Pt(),weight_ee);
                    ...
                    if(Muon_Emin > Muon_Emin_cut){
                        ...
                        if(Muon1.E() < Muon2.E()){Muon_Emin=Muon1.E();Muon_Ptmin=Muon1.Pt(); ForwardMuon_PT_plot_ff_bkg->Fill(Muon1.Pt(),weight_ee);}
  ...
  std::cout <<"Pt<600_jj_bkg:"<<countnumber_jj_bkg[6]<<"->"<<countnumber_jj_bkg[6]/countnumber_jj_bkg[0]<<std::endl;
  ...
  std::cout <<"Pt<600_ww_bkg:"<<countnumber_ww_bkg[6]<<"->"<<countnumber_ww_bkg[6]/countnumber_ww_bkg[0]<<std::endl;
  ...
  std::cout <<"Pt<600_mumua_bkg:"<<countnumber_mumua_bkg[6]<<"->"<<countnumber_mumua_bkg[6]/countnumber_mumua_bkg[0]<<std::endl;
  ...
  std::cout <<"Pt<600_vmvm_bkg:"<<countnumber_vmvm_bkg[6]<<"->"<<countnumber_vmvm_bkg[6]/countnumber_vmvm_bkg[0]<<std::endl;
  ...
  std::cout <<"Pt<600_ee_bkg:"<<countnumber_ee_bkg[6]<<"->"<<countnumber_ee_bkg[6]/countnumber_ee_bkg[0]<<std::endl;
  
  // compute significance
  double xs_b=1.5*countnumber_jj_bkg[6]/countnumber_jj_bkg[0] + 0.3386*countnumber_ww_bkg[6]/countnumber_ww_bkg[0] + 753.9*countnumber_mumua_bkg[6]/countnumber_mumua_bkg[0] + 1.04*countnumber_vmvm_bkg[6]/countnumber_vmvm_bkg[0] + 2.7*countnumber_ee_bkg[6]/countnumber_ee_bkg[0]; 
  double xs_s=0.05*countnumber_signal[6]/countnumber_signal[0];
  double B=xs_b*1000000;
  double S=xs_s*1000000;
  double delta_95=sqrt(B)/S*1.96/2;
  double delta_90=sqrt(B)/S*1.64/2;
  double delta_68=sqrt(B)/S*1.0/2;
  ...
  std::cout <<"#delta_{68%}:"<<delta_68<<std::endl;
  ...
  ForwardMuon_Eta_plot_mumua_bkg->Draw("HIST");
  ForwardMuon_Eta_plot_signal->Draw("same" "HIST");
  ...
  c110->SetGridx();
  c110->SetGridy();
  c110->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/3_TeV/output_plot/reco_level_morecut_eta4/ForwardMuon_Eta.pdf");
  ...
  c120->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/3_TeV/output_plot/reco_level_morecut_eta4/ForwardMuon_E.png");
  ...
  ForwardMuon_PT_plot_mumua_bkg->Draw("HIST");
  ...
  c130->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/3_TeV/output_plot/reco_level_morecut_eta4/ForwardMuon_PT.pdf");
  
  
  
  
  TCanvas *c3 = new TCanvas();
  Higgs_mass_plot_mumua_bkg->SetStats(0);
  ...
  c3->SetGridx();
  c3->SetGridy();
  c3->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/3_TeV/output_plot/reco_level_morecut_eta4/Higgs_mass_plot.pdf");
  ...
  c10->SetGridx();
  c10->SetGridy();
  c10->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/3_TeV/output_plot/reco_level_morecut_eta4/ForwardMuon_Emin_plot.pdf");
  
  /*
  TCanvas *c131 = new TCanvas();
  ForwardMuon_PT_plot_mumua_bkg->SetStats(0);
  ForwardMuon_PT_plot_signal->SetLineColor(2);
  ForwardMuon_PT_plot_ff_bkg->SetLineColor(1);
  ForwardMuon_PT_plot_ww_bkg->SetLineColor(6);
  ForwardMuon_PT_plot_mumua_bkg->SetLineColor(4);
  ForwardMuon_PT_plot_signal->SetLineWidth(3);
  ...
  ForwardMuon_PT_plot_mumua_bkg->GetXaxis()->SetLabelSize(0.04);
  ForwardMuon_PT_plot_mumua_bkg->GetYaxis()->SetLabelSize(0.04);
  ForwardMuon_PT_plot_mumua_bkg->GetYaxis()->SetRangeUser(0,0.6);

  ForwardMuon_PT_plot_mumua_bkg->DrawNormalized("HIST");
  //ForwardMuon_PT_plot_ff_bkg->Draw("same" "HIST");
  //ForwardMuon_PT_plot_ww_bkg->Draw("same" "HIST");
  ForwardMuon_PT_plot_signal->DrawNormalized("same" "HIST");*/
