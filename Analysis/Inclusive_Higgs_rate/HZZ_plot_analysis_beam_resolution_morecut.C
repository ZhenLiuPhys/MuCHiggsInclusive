...
void HZZ_plot_analysis_beam_resolution_morecut(){
  ...
  */
  ...
  for (int i=0; i<entries0; ++i){
    ...
    double Higgs_mass=-9999;
    double Twomuon_PT=-9999;
    double Muon_Emin=-9999;
    double Muon_Ptmin=-9999;
  ...
  std::cout <<"Pt<300_signal:"<<countnumber_signal[6]<<"->"<<countnumber_signal[6]/countnumber_signal[0]<<std::endl;
  ...
  std::cout <<"Pt<300_jj_bkg:"<<countnumber_jj_bkg[6]<<"->"<<countnumber_jj_bkg[6]/countnumber_jj_bkg[0]<<std::endl;
  ...
  std::cout <<"Pt<300_ww_bkg:"<<countnumber_ww_bkg[6]<<"->"<<countnumber_ww_bkg[6]/countnumber_ww_bkg[0]<<std::endl;
  ...
  std::cout <<"Pt<300_mumua_bkg:"<<countnumber_mumua_bkg[6]<<"->"<<countnumber_mumua_bkg[6]/countnumber_mumua_bkg[0]<<std::endl;
  ...
  std::cout <<"Pt<300_vmvm_bkg:"<<countnumber_vmvm_bkg[6]<<"->"<<countnumber_vmvm_bkg[6]/countnumber_vmvm_bkg[0]<<std::endl;
  ...
  std::cout <<"Pt<300_ee_bkg:"<<countnumber_ee_bkg[6]<<"->"<<countnumber_ee_bkg[6]/countnumber_ee_bkg[0]<<std::endl;
  
  // compute significance
  double xs_b=2.058*countnumber_jj_bkg[6]/countnumber_jj_bkg[0] + 0.939*countnumber_ww_bkg[6]/countnumber_ww_bkg[0] + 754.8*countnumber_mumua_bkg[6]/countnumber_mumua_bkg[0] + 1.68*countnumber_vmvm_bkg[6]/countnumber_vmvm_bkg[0] + 3.96*countnumber_ee_bkg[6]/countnumber_ee_bkg[0]; 
  double xs_s=0.0867*countnumber_signal[6]/countnumber_signal[0];
  ...
  c130->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_morecut/ForwardMuon_PT.pdf");
  ...
  c3->SetGridx();
  c3->SetGridy();
  c3->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_morecut/Higgs_mass_plot.pdf");
  ...
  c10->SetGridx();
  c10->SetGridy();
  c10->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_morecut/ForwardMuon_Emin_plot.pdf");
