...
void HZZ_plot_analysis_beam_resolution_eta6(){
  ...
  for (int i=0; i<entries0; ++i){
    ...
    if(ForwardMuon_size == 2) {
        ...
        if(abs(ForwardMuon_Eta[0])>6 || abs(ForwardMuon_Eta[1])>6){continue;}
  ...
  c110->SetTicky();
  c110->SetGridx();
  c110->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta6/ForwardMuon_Eta.png");
  ...
  c120->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta6/ForwardMuon_E.png");
  ...
  c130->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta6/ForwardMuon_PT.png");
  ...
  c3->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta6/Higgs_mass_plot.png");
  ...
  c10->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta6/ForwardMuon_Emin_plot.png");
