...
void HZZ_plot_analysis_beam_resolution_eta4(){
        ...
        if((ForwardMuon_Eta[0] > 0 && ForwardMuon_Eta[1]<0)||(ForwardMuon_Eta[1] > 0 && ForwardMuon_Eta[0]<0)){
            ...
            if(ForwardMuon_PT[0]>20 && ForwardMuon_PT[1]>20){
                ...
                if(Twomuon_PT > 50){
                    ...
                    if(Muon_Emin > 3000 && Muon_Ptmin<300){
  ...
  double xs_b=2.058*countnumber_jj_bkg[5]/countnumber_jj_bkg[0] + 0.9387*countnumber_ww_bkg[5]/countnumber_ww_bkg[0] + 754.8*countnumber_mumua_bkg[5]/countnumber_mumua_bkg[0] + 1.68*countnumber_vmvm_bkg[5]/countnumber_vmvm_bkg[0] + 3.96*countnumber_ee_bkg[5]/countnumber_ee_bkg[0]; 
  ...
  ForwardMuon_Eta_plot_signal->SetLineColor(2);
  ForwardMuon_Eta_plot_ff_bkg->SetLineColor(1);
  ForwardMuon_Eta_plot_ww_bkg->SetLineColor(6);
  ForwardMuon_Eta_plot_mumua_bkg->SetLineColor(4);
  ...
  c110->SetTicky();
  c110->SetGridx();
  c110->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta4/ForwardMuon_Eta.png");
  ...
  c120->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta4/ForwardMuon_E.png");
  ...
  c130->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta4/ForwardMuon_PT.png");
  ...
  Higgs_mass_plot_signal->SetLineColor(2);
  Higgs_mass_plot_ff_bkg->SetLineColor(1);
  Higgs_mass_plot_ww_bkg->SetLineColor(6);
  Higgs_mass_plot_mumua_bkg->SetLineColor(4);
  ...
  c3->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta4/Higgs_mass_plot.png");
  ...
  ForwardMuon_Emin_plot_signal->SetLineColor(2);
  ForwardMuon_Emin_plot_ff_bkg->SetLineColor(1);
  ForwardMuon_Emin_plot_ww_bkg->SetLineColor(6);
  ForwardMuon_Emin_plot_mumua_bkg->SetLineColor(4);
  ...
  c10->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/reco_level_eta4/ForwardMuon_Emin_plot.png");
  
  
  /*TCanvas *c21 = new TCanvas();
  ForwardMuon_E_2d_plot_signal->SetLineColor(2);
  //ForwardMuon_E_2d_plot_total_bkg->SetLineColor(1);
  ForwardMuon_E_2d_plot_signal->Draw();
  //ForwardMuon_E_2d_plot_total_bkg->Draw("same");
  
  
  c21->SaveAs("/mnt/e/Madgraph/MG5_aMC_v3_4_0/HZZ_bkg/plot_macro/output_plot/ForwardMuon_E_2D_plot.png");*/
